...
{
    public static (bool,Vector2) IsCrossed(Vector2 start, Vector2 end, Vector2 positionCurrent, Vector2 positionNext)
    {
        ...
        if (denominator != 0)
        {
            ...
            return (consist, collisionPoint);
        }
        else return (false, new Vector2()); 
    }
}
